...
2. The coefficients from the result of the long division become the values for the inverse: $$x(0) = 0$$, $$x(1) = 1$$, $$x(2) = 3$$, $$x(3) = 7$$, ... 
3. The general form of this sequence is $$x(k) = 2^k - 1$$.
